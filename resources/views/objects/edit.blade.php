...
@section('content')
    <div class="flex flex-col items-center max-w-screen-sm mx-auto">
        ...
        <h1 class="text-gray-500 text-3xl pt-6 mb-6">{{ __('Edit JSON Object') }}</h1>

        <form id="object_form" action="{{ route('objects.update') }}" class="w-full" method="POST">
